...
class EnergyEmployeeFullHistory extends Component {
    constructor() {
        super();
            ...
            <div>
                ...
                <div className="container-fluid">
                    <div className="row justify-content-around align-items-center">
                        <Link to="/energyemployee/analytics"><button className="btn btn-primary">&#8592; Back to analytics</button></Link>
                    </div>
...
export default EnergyEmployeeFullHistory;
